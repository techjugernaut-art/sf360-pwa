...
@Component({
  selector: 'app-purchase-sms-credit',
  templateUrl: './purchase-sms-credit.component.html'
})
export class PurchaseSmsCreditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.pageHeaderOptions = { pageTitle: 'SMS Packages', hasShopsFilter: true, ignoreFilterByAllShops: true };
