...
@Component({
  selector: 'app-offline-shop-premium-plans',
  templateUrl: './offline-shop-premium-plans.component.html',
  styleUrls: ['./offline-shop-premium-plans.component.scss']
})
export class OfflineShopPremiumPlansComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.pageHeaderOptions = { pageTitle: 'Offline Shop Subscriptions', hasShopsFilter: true, ignoreFilterByAllShops: true, hideFilterPanel: true };
