...
import { ReadPaymentRequestRequirementsComponent } from '../read-payment-request-requirements/read-payment-request-requirements.component';
declare const swal;

@Component({
  selector: 'app-edit-payment-request-dialog',
  templateUrl: './edit-payment-request-dialog.component.html'
})
export class EditPaymentRequestDialogComponent implements OnInit {

    pageHeaderOptions: IPageHeader;
    paymentRequestTypesEnums = PaymentRequestTypesEnums
    isProcessing = false;
    ...
    shopInfo: any;
    countryFlag: string;
    countryFlagSecondary: string;
    initialDate = new Date()
    getYear = this.initialDate.getFullYear() - 18
    getMonth = this.initialDate.getMonth() 
    getDay = this.initialDate.getDay()
    maxDate = new Date(this.getYear, this.getMonth, this.getDay )
    shopData: any;
    paymentRequest: any;
    constructor(
      ...
      private dialogRef: MatDialogRef<EditPaymentRequestDialogComponent>,
    ...
    ngOnInit() {
      ...
      // console.log(this.paymentRequest, 'paymentRequest to edit')
      ...
      if(this.paymentRequest != null){
        this.businessInformationFormGroup = new FormGroup({
          // payment_request_id: new FormControl(this.paymentRequest.id, [Validators.required]),
          shop_id: new FormControl(this.paymentRequest.shop_id, [Validators.required]),
          business_name: new FormControl(this.paymentRequest.business_name, [Validators.required]),
          business_type: new FormControl(this.paymentRequest.business_type, [Validators.required]),
          trading_name: new FormControl(this.paymentRequest.trading_name),
          business_category: new FormControl(this.paymentRequest.business_category, [Validators.required]),
          // country: new FormControl(this.paymentRequest.country, [Validators.required]),
          business_state_of_residence: new FormControl(this.paymentRequest.business_state_of_residence),
          // business_city_of_residence: new FormControl(this.paymentRequest.business_city_of_residence, [Validators.required]),
          business_address: new FormControl(this.paymentRequest.business_address, [Validators.required]),
          tin: new FormControl(this.paymentRequest.tin, [Validators.required]),
          bvn: new FormControl(this.paymentRequest.bvn, [Validators.required]),
          description_and_nature_of_business: new FormControl(this.paymentRequest.description_and_nature_of_business),
          business_registration_number: new FormControl(this.paymentRequest.business_registration_number),
          reseller_code: new FormControl(this.paymentRequest.reseller_code),
          secondary_contact_name: new FormControl(this.paymentRequest.secondary_contact_name), 
          secondary_contact_picture: new FormControl(this.paymentRequest.secondary_contact_picture),
          secondary_contact_phone: new FormControl(this.paymentRequest.secondary_contact_phone, [Validators.required]),
          secondary_contact_email: new FormControl(this.paymentRequest.secondary_contact_email, [Validators.required, Validators.email]),
        ...
        this.primaryContactInformationFormGroup = new FormGroup({
          primary_contact_name: new FormControl(this.paymentRequest.primary_contact_name, [Validators.required]),
          primary_contact_phone: new FormControl(this.paymentRequest.primary_contact_phone, [Validators.required]),
          primary_contact_email: new FormControl(this.paymentRequest.primary_contact_email, [Validators.email]),
          primary_contact_picture: new FormControl(this.paymentRequest.primary_contact_picture),
          date_of_birth: new FormControl(this.paymentRequest.date_of_birth, [Validators.required])
    
        });
        this.bankInformationFormGroup = new FormGroup({
          bank_account_name: new FormControl(this.paymentRequest.bank_account_name, [Validators.required]),
          bank_account_number: new FormControl(this.paymentRequest.bank_account_number, [Validators.required]),
          account_type: new FormControl(this.paymentRequest.account_type, [Validators.required]),
          bank_branch: new FormControl(this.paymentRequest.bank_branch, [Validators.required]),
          bank_name: new FormControl(this.paymentRequest.bank_name, [Validators.required]),
          mobile_money_number: new FormControl(this.paymentRequest.mobile_money_number),
          prefered_payment_method: new FormControl(this.preferedPaymentMethods.BANK, [Validators.required]),
          mobile_money_network: new FormControl(this.paymentRequest.mobile_money_network)
        });
        this.companyDocumentationFormGroup = new FormGroup({
          certificate_of_incorporation: new FormControl(this.paymentRequest.certificate_of_incorporation),
          certificate_of_commencement: new FormControl(this.paymentRequest.certificate_of_commencement),
          national_id_picture: new FormControl(this.paymentRequest.national_id_picture, [Validators.required]),
          recent_utility_bill: new FormControl(this.paymentRequest.recent_utility_bill, [Validators.required]),
          certificate_of_registration:  new FormControl(this.paymentRequest.certificate_of_registration, [Validators.required]),
          cac_bn:  new FormControl(this.paymentRequest.cac_bn, [Validators.required]),
          memorandum_and_articles_of_association:  new FormControl(this.paymentRequest.memorandum_and_articles_of_association, [Validators.required]),
          form_cac_7:  new FormControl(this.paymentRequest.form_cac_7, [Validators.required]),
          form_cac_2: new FormControl(this.paymentRequest.form_cac_2, [Validators.required]),
          shareholders_valid_id: new FormControl(this.paymentRequest.shareholders_valid_id, [Validators.required]),
          partnership_agreement: new FormControl(this.paymentRequest.partnership_agreement),
          valid_registered_proprietors_or_partnerships_id_doc: new FormControl(this.paymentRequest.valid_registered_proprietors_or_partnerships_id_doc),
          scuml_certificate: new FormControl(this.paymentRequest.scuml_certificate),
          ngo_reg_certificate: new FormControl(this.paymentRequest.ngo_reg_certificate, [Validators.required]),
          cooperative_registration_certificate: new FormControl(this.paymentRequest.cooperative_registration_certificate, [Validators.required]),
          certified_copies_of_association_constitution: new FormControl(this.paymentRequest.certified_copies_of_association_constitution),
          resolution_authorizing_business_establishment: new FormControl(this.paymentRequest.resolution_authorizing_business_establishment),
          requisite_government_approval_or_gazette: new FormControl(this.paymentRequest.requisite_government_approval_or_gazette),
          form_cac_1_1: new FormControl(this.paymentRequest.form_cac_1_1),
          board_resolution: new FormControl(this.paymentRequest.board_resolution),
          operating_license: new FormControl(this.paymentRequest.operating_license),
          evidence_of_listing_on_the_stock_exchange: new FormControl(this.paymentRequest.evidence_of_listing_on_the_stock_exchange)
        });
      }
      ...
      this.country.valueChanges.subscribe(value => {
        ...
        this.bvn.setValue('');
        this.date_of_birth.clearValidators();
        ...
        this.business_type.clearValidators();
        this.business_type.setValue('');
        this.date_of_birth.clearValidators();
        this.date_of_birth.setValue('');
        this.description_and_nature_of_business.setValue('');
        this.description_and_nature_of_business.clearValidators();
        this.evidence_of_listing_on_the_stock_exchange.setValue('');
        this.companyDocumentationFormGroup.updateValueAndValidity();
        this.banks = this.globalData.getGhanaianBanks;
        if (value === CountriesEnums.GH) {
          this.tin.setValidators([Validators.required]);
        ...
        if (value === CountriesEnums.NG) {
          ...
          this.business_state_of_residence.setValidators([Validators.required]);
          this.business_type.setValidators([Validators.required]);
          // tslint:disable-next-line: max-line-length
          if (this.business_type.value === BusinessTypesEnums.SOLE_PROPRIETORSHIP || this.business_type.value === BusinessTypesEnums.PARTNERSHIP) {
            ...
            // this.certificate_of_registration.updateValueAndValidity();
            // this.cac_bn.setValidators([Validators.required]);
            // this.cac_bn.updateValueAndValidity();
            // this.national_id_picture.setValidators([Validators.required]);
            // this.national_id_picture.updateValueAndValidity();
            this.memorandum_and_articles_of_association.clearValidators();
            this.memorandum_and_articles_of_association.updateValueAndValidity();
            this.shareholders_valid_id.clearValidators();
            this.shareholders_valid_id.updateValueAndValidity();
            this.form_cac_2.clearValidators();
            this.form_cac_2.updateValueAndValidity();
            this.form_cac_7.clearValidators();
            this.form_cac_7.updateValueAndValidity();
            this.certificate_of_incorporation.clearValidators();
            this.certificate_of_incorporation.updateValueAndValidity();
            this.certificate_of_commencement.clearValidators();
            this.certificate_of_commencement.updateValueAndValidity();
          ...
          //   this.evidence_of_listing_on_the_stock_exchange.setValidators([Validators.required]);
            ...
            // this.form_cac_7.updateValueAndValidity();
            // this.form_cac_2.setValidators([Validators.required]);
            // this.form_cac_2.updateValueAndValidity();
            this.certificate_of_registration.clearValidators();
            this.certificate_of_registration.updateValueAndValidity();
            this.cac_bn.clearValidators();
            ...
            this.certificate_of_commencement.clearValidators();
            this.certificate_of_commencement.updateValueAndValidity();
            this.national_id_picture.clearValidators();
            this.national_id_picture.updateValueAndValidity();
    ...
    onSubmitPaymetRequest() {    
      ...
      // this.business_address.setValue(this.business_address.value + ' - ' + this.business_city_of_residence.value);
       //tslint:disable-next-line:max-line-length
      const payload = JSON.parse('{' + this.appUtils.removeSpecialCharacters(JSON.stringify(this.businessInformationFormGroup.value) + ',' + JSON.stringify(this.primaryContactInformationFormGroup.value) + ',' + JSON.stringify(this.paymentOptionsForm.value) + ','  + JSON.stringify(this.bankInformationFormGroup.value) + ',' + JSON.stringify(this.companyDocumentationFormGroup.value)) + '}');
      ...
      if (this.isEdit) {
        payload.payment_request_id = this.paymentRequest.id;
      }
      const self = this;
      swal({
        title: 'Are you sure?',
          ...
          if (self.isEdit) {
            self.shopsService.updatePaymentRequest(payload, (error, result) => {
              if (result !== null && result.response_code === '100') {
                swal('Payment Request', 'Payment Request successfully updated', 'success');
   ...
   */
    ...
    readRequirements(){
      this.dialog.open(ReadPaymentRequestRequirementsComponent, { data: {},  position: {bottom: '30px', top: '10px' }, disableClose: true});
    }
    ...
    // get business_city_of_residence() { return this.businessInformationFormGroup.get('business_city_of_residence'); }
    get payment_request_type() { return this.paymentOptionsForm.get('payment_request_type'); }
    ...
    get bvn() { return this.businessInformationFormGroup.get('bvn'); }
    ...
    get certificate_of_incorporation() { return this.companyDocumentationFormGroup.get('certificate_of_incorporation'); }
    get certificate_of_commencement() { return this.companyDocumentationFormGroup.get('certificate_of_commencement'); }
    get national_id_picture() { return this.companyDocumentationFormGroup.get('national_id_picture'); }
    get recent_utility_bill() { return this.companyDocumentationFormGroup.get('recent_utility_bill'); }
